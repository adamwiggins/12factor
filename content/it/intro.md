...
* Sono **adatti allo sviluppo** sulle più recenti **cloud platform**, ovviando alla necessità di server ed amministrazioni di sistema;
...
La metodologia twelve-factor può essere applicata ad ogni software, scritto in qualsiasi linguaggio di programmazione, che fa uso di una serie di servizi come database, code, cache e così via.